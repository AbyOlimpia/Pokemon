...
public class ListaMov {
    ...
    public static void inicializarListasDeMovimientos() {
        ...
        movimientosMejora.add(new MejoraAtk("El Afilador", Tipo.ELECTRICO, 3, null, 0));
        movimientosMejora.add(new MejoraAtk("El Tapicero", Tipo.TIERRA, 3, null, 0));
        movimientosMejora.add(new MejoraAtk("La Jungla", Tipo.PLANTA, 3, MejoraStats.ATAQUE, 10));
